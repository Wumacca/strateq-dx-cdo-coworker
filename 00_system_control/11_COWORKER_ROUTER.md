...
- `00_system_control/12_CLIENT_WORKSPACE_INTERFACE_STANDARD.md`
...
Where the session concerns a client programme, a client artefact, a client capex request, a client delivery status, a client handover, or a client evidence record, the router must first resolve the **active client workspace** under `00_system_control/12_CLIENT_WORKSPACE_INTERFACE_STANDARD.md`, before jurisdiction execution and before the interactive gates below.
...
- resolution and the read/write boundary are governed by `00_system_control/12_CLIENT_WORKSPACE_INTERFACE_STANDARD.md`.
