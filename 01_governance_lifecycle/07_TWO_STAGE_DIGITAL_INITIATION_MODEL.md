...
Before launching a Stage 1 or Stage 2 session, Claude must confirm the initiative route from the Jira screenshot or Initiative Type field.

| Route | Primary governing file | Default path |
|---|---|---|
| Development Route (Chronos Dev, Omega Dev, SharePoint build, Power BI build, in-house tool) | `01_governance_lifecycle/08_DEVELOPMENT_ROUTE_STAGE_1D_MODEL.md` | Stage 1D only, unless Stage 2 exception gate triggers |
| Implementation / Support Route (third-party implementation, supplier-led, external platform, option appraisal, business case / funding) | This file | Stage 1 → Stage 2 |
...
Claude must first check the initiative route. If the initiative is a Development Route, Claude must apply `01_governance_lifecycle/08_DEVELOPMENT_ROUTE_STAGE_1D_MODEL.md` instead of this workflow.

If the initiative is an Implementation / Support Route, Claude must launch the Stage 1 Hopper Clarification workflow below.
...
This stage applies to the Implementation / Support Route.
...
Stage 2 applies to the Implementation / Support Route as the standard second stage.

Stage 2 applies to the Development Route only when a Stage 2 exception trigger has been confirmed under `01_governance_lifecycle/08_DEVELOPMENT_ROUTE_STAGE_1D_MODEL.md`.
...
Claude must not apply this two-stage model to Development Route initiatives unless a Stage 2 exception trigger has been confirmed under `01_governance_lifecycle/08_DEVELOPMENT_ROUTE_STAGE_1D_MODEL.md`.
