...
| Board / leadership reporting interface | `BOARD_INTERFACE/BOARD_REPO_INDEX.md`; `docs/presentation-standards/communication-and-framing-standard.md` where present; `02_coworker_artifact_interface/09_MIERUKA_AND_ACTION_DISPLAY_FEED_STANDARD.md` where a display projection / Mieruka feed is produced |
